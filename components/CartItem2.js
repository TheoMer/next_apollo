          ...
          optimisticResponse: {
            ...
            updateCartItem: {
              ...
              ItemVariants: {
                ...
                id: props.cartItem.ItemVariants.id,
                price: props.cartItem.ItemVariants.price,
                image: props.cartItem.ItemVariants.image,
                largeImage: props.cartItem.ItemVariants.largeImage,
                title: props.cartItem.ItemVariants.title,
                description: props.cartItem.ItemVariants.description,
                mainDescription: props.cartItem.ItemVariants.mainDescription,
                quantity: parseInt(props.cartItem.ItemVariants.quantity),
                Color: props.cartItem.ItemVariants.color,
                Size: props.cartItem.ItemVariants.size, 
                Item: {
                  __typename: 'Item',
                  ...props.cartItem.item
                }
          ...
          <Form2 key={cartItem.id} onSubmit={e => updateCartItem2(e, updateCartItem)}>
            ...
            <table width="100%" border="0" cellPadding="0">
                ...
                <tr>
                  ...
                  <td valign="top" margin="50px" width="3.3%" align="center"><em> {formatMoney(cartItem.ItemVariants.price)}</em></td>
